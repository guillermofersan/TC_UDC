...
mapdoble (function x -> x*2) (function x -> x/2) [1;2;3;4;5];;
...
(*dado un predicado y una lista, devuelva el primer elemento de la lista que verifica dicho predicado. *)
...
conjunto_of_list [1;2;3;5;6;1;5;2;1;5;7;1];;
...
incluido c (Conjunto [0;1;2;3;4;5;6;7;8]);;
